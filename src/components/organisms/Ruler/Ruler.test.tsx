...
describe('Ruler', () => {
  ...
  describe('Rendering', () => {
    it('should render the ruler component', () => {
      renderWithProviders(<Ruler {...defaultProps} />);
  ...
  describe('Zoom Scaling', () => {
    it('should scale bar positions with zoom level', () => {
      ...
      renderWithProviders(<Ruler {...defaultProps} viewport={viewport50} />);
    ...
    it('should show more bars when zoomed in', () => {
      const viewport50: ViewportState = { ...defaultViewport, zoom: 50 };
      const { rerender } = renderWithProviders(<Ruler {...defaultProps} viewport={viewport50} />);
  ...
  describe('Bar Numbering', () => {
    ...
    it('should show sequential bar numbers', () => {
      ...
      renderWithProviders(<Ruler {...defaultProps} viewport={viewport2000} />);
  ...
  describe('Grid Markers', () => {
    it('should render grid ticks between bars', () => {
      ...
      renderWithProviders(<Ruler {...defaultProps} viewport={viewport800} />);
  ...
  describe('Edge Cases', () => {
    it('should handle very small zoom levels', () => {
      ...
      renderWithProviders(<Ruler {...defaultProps} viewport={viewport10} />);
    ...
    it('should handle very large zoom levels', () => {
      ...
      renderWithProviders(<Ruler {...defaultProps} viewport={viewport400} />);
      // Should still render without crashing
      expect(screen.getByTestId('ruler')).toBeInTheDocument();
    });
    ...
    it('should handle zero container width gracefully', () => {
      ...
      renderWithProviders(<Ruler {...defaultProps} viewport={viewport0} />);
    ...
    it('should handle very wide containers', () => {
      ...
      renderWithProviders(<Ruler {...defaultProps} viewport={viewport10000} />);
  ...
  describe('Visual Hierarchy', () => {
    ...
    it('should adapt grid density based on zoom level', () => {
      ...
      const { rerender } = renderWithProviders(<Ruler {...defaultProps} viewport={viewportLowZoom} />);
